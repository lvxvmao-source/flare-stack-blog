...
export function AcgThemeSettings() {
  const {
    register,
    formState: { errors },
  ...
  return (
    <>
      <Field
        ...
        error={errors.site?.theme?.acg?.navBarName?.message}
      >
        <Input
          {...register("site.theme.acg.navBarName")}
          className={getInputClassName(
            errors.site?.theme?.acg?.navBarName?.message,
          )}
          placeholder={m.settings_site_field_navbar_name_ph()}
        />
      </Field>
      <AssetUploadField
        name="site.theme.acg.background.homeImage"
        assetPath="themes/acg/home-image.webp"
        accept=".png,.webp,.jpg,.jpeg"
        label={m.settings_site_field_home_image()}
        hint={m.settings_site_field_home_image_hint()}
        placeholder="/images/asset/themes/acg/home-image.webp or https://picsum.photos/1600/900"
        error={errors.site?.theme?.acg?.background?.homeImage?.message}
      />
      <AssetUploadField
        name="site.theme.acg.background.globalImage"
        assetPath="themes/acg/global-image.webp"
        accept=".png,.webp,.jpg,.jpeg"
        label={m.settings_site_field_global_image()}
        hint={m.settings_site_field_global_image_hint()}
        placeholder="/images/asset/themes/acg/global-image.webp or https://picsum.photos/1600/900"
        error={errors.site?.theme?.acg?.background?.globalImage?.message}
      />
      <RangeField
        name="site.theme.acg.background.light.opacity"
        ...
        error={errors.site?.theme?.acg?.background?.light?.opacity?.message}
      />
      <RangeField
        name="site.theme.acg.background.dark.opacity"
        ...
        defaultValue={0.1}
        formatValue={(value) => value.toFixed(2)}
        error={errors.site?.theme?.acg?.background?.dark?.opacity?.message}
      />
      <RangeField
        name="site.theme.acg.background.backdropBlur"
        ...
        unit="px"
        defaultValue={8}
        error={errors.site?.theme?.acg?.background?.backdropBlur?.message}
      />
      <RangeField
        name="site.theme.acg.background.transitionDuration"
        ...
        defaultValue={600}
        error={
          errors.site?.theme?.acg?.background?.transitionDuration?.message
        }
      />
    </>
  );
